  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="developers1.jpg" width=100 height=100 alt="BSH_Team" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">BSH Team</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9696026202</h4>
		<h4 style="font-family:'typo' ">bsh08@gmail.com</h4>
		<h4 style="font-family:'typo' ">Ambition Institute Of Technology, Varanasi</h4></div></div>
		</p>
      </div>
