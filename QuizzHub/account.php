...
<div class="row">
<div class="col-lg-6">
<span class="logo"><b style="margin-top:10px; font-weight:bolder;">Test Your Skill</b></span></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <a href="http://yugeshverma.blogspot.in"
                               style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Yugesh
                                Verma</a>
